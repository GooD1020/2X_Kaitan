            ...
            return tostring(
              " "
                   ..
                        ...
                        Gamename.. "!" .. " กด ช่อง Main2 เพื่อ กดโค้ด"
            )
      end
   }
}
...
do local GUI = game.CoreGui:FindFirstChild("2XUi");if GUI then GUI:Destroy();end;if _G.Color == nil then
    _G.Color = Color3.fromRGB(255,255,255)--เน€เธเธฅเธตเธขเธเธชเธต
	_G.ColorBackground = Color3.fromRGB(0,0,0)
   	_G.ColorText = Color3.fromRGB(255,255,255)--เน€เธเธฅเธตเธขเธเธชเธต
...
function Update:Window(text,logo,keybind)
	...
	Logo.Image = "rbxassetid://10240321390"--เธฃเธนเธ
    ...
    IMGNAME.BackgroundTransparency = 0
    IMGNAME.Position = UDim2.new(0, -1.9, 0, 0)
    IMGNAME.Size = UDim2.new(0, 115, 0, 100)
    IMGNAME.Image = "rbxassetid://10240321390"--เธฃเธนเธ
--[[
...
--เน€เธญเธฒเธกเธฑเนเธข By NaJa
    ...
    IM10GNAME.Image = "rbxassetid://10240321390"--เธฃเธนเธ
...
local Main4 = Library:Tab("Main2")

Main3:Toggle("Auto Farm ",false,function(value)
  
    _G.AutoFarm = value
end)

Main3:Toggle("fast Attack",true,function(value)
...
Main3:Toggle("Bring Mob",true,function(Mag)
    ...
    Main3:Toggle("remove attack",false,function(value)
...
Main3:Toggle("Kaitan Stats",true,function(vu)
        _G.Melee = vu
        _G.Defense = vu
    end)
    ...
    Main3:Toggle("Super VeryFast Attack",nil,function(value)
...
Main4:Button("Fps Boost",function()
...
Main4:Toggle("White Screen Mode",_G.WhiteScreen,function(value)
...
Main4:Toggle("Auto Haki",true,function(value)
_G.AUTOHAKI = value
end)
spawn(function()
    while wait(.1) do
...
Main4:Toggle("Auto SetSpawn Point",true,function(x)
    _G.Set = x
end)
...
Main4:Button("Redeem All code",function()
    function Code(Text)
